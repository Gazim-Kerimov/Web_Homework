<?php
	$job_types = ['Комитет по строительству Правительства Ленинградской области', 'АО АКВАМАРИН'];
    $name = 'Газим';
    $prof = 'Юрист';
    $town = 'Российская Федерация, г.Санкт-Петербург';
    $mail = 'gazim94@mail.ru';
    $skills = ['Adobe Photoshop', 'Java', 'Python', 'Driving'];
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $job_types[1] ?> </b></h5>
          ...
          <p>Ведущий юрист юридической службы организации</p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $job_types[0] ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>Sept 2016 - Feb 2018</h6>
          <p>Главный специалист отдела расселения аварийного жилья</p>
          <hr>
        </div>
